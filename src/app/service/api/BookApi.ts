...
export class BookApi {
     ...
     *
     */
    public countAllBooks (extraHttpRequestParams?: any ) : Observable<number> {
     ...
     *
     */
    public findAllBooks (extraHttpRequestParams?: any ) : Observable<Array<models.Book>> {
        const path = this.basePath + '/books';
     ...
     * @param id
     */
    public findBook (id: number, extraHttpRequestParams?: any ) : Observable<models.Book> {
        const path = this.basePath + '/books/{id}'
            .replace('{' + 'id' + '}', String(id));
